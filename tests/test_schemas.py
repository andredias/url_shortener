...
from url_shortener.schemas import diff_models
from url_shortener.schemas.user import UserInsert, UserPatch, check_password


def test_diff_models() -> None:
    insert = UserInsert(
        name='Fulano', email='fulano@email.com', password='123456 foo bar.'
    )
